...
functions = [
            ...
            {name:'collections',public:true,uri:'/collections/list:create',isadmin:true},
            ...
            {name:'startproject:create',public:false,uri:'/startproject:create',isadmin:true},
            {name:'startproject',public:false,uri:'/startproject',isadmin:false},
            ...
            {name:'workconfiguration',public:false,uri:'/work:configuration',isadmin:true},
...
functionendpoints = [
    ...
    {name:'',isAdmin:false,public:false,endpoint:'collection#create'},
    {name:'',isAdmin:false,public:false,endpoint:'collection#update'},
    {name:'',isAdmin:false,public:false,endpoint:'collection#destroy'}, 
