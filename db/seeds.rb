...
functions = [
            ...
            {name:'workconfiguration',public:false,uri:'/work:configuration',isadmin:false},
            {name:'transcribe:transcribe',public:false,uri:'/transcribe:transcribe',isadmin:false},
            {name:'collectionslist:config',public:false,uri:'/collections/list:config',isadmin:false},
