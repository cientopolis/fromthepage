...
ActiveRecord::Schema.define(version: 20171217115802) do
  ...
  create_table "marks", force: :cascade do |t|
    ...
    t.float   "end_x",           limit: 24
    t.float   "end_y",           limit: 24
  end

  add_index "marks", ["page_version_id"], name: "index_marks_on_page_version_id", using: :btree
